...
> 
> ```markdown
> ![JavaScript Example](images/javascript-example.png)
> ![React Example](images/react-example.png)
> ![Terminal](images/terminal-example.png)
> ```
...
Found an issue or have a suggestion? Please open an issue on the [GitHub repository](https://github.com/Joabits/bits-dark-theme).
